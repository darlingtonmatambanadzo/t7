...
download_results() {
    ...
    vastai rsync $instance_id:/workspace/bitcoin-puzzle-solver/data/results/ "$local_dir/" --download
    
    # Download logs
    vastai rsync $instance_id:/workspace/bitcoin-puzzle-solver/data/logs/ "$local_dir/logs/" --download
